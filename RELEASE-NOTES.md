...
BehaviorDiff 0.3.0 completes the distribution and confidentiality work around the Rust architecture.
...
- The public `behaviordiff` executable is now a thin Rust launcher. It owns argument routing, `.behaviordiff/config.yml` loading, language detection, and managed-process spawning; risky repository orchestration remains in the self-contained managed component.
