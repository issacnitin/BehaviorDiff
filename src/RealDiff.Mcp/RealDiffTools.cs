...
/// </summary>
[McpServerToolType]
public static class RealDiffTools
{
    ...
    [Description("""
        Starts a RealDiff analysis of a pull request and returns immediately with a run_id.
        It does NOT wait for the analysis; poll get_run_status until status is 'complete' or 'refused'.

        RealDiff compares the RUNTIME BEHAVIOR of two builds by running the repository's own test
