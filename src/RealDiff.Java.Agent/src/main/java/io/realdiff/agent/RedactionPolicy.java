...
final class RedactionPolicy {
    ...
    static RedactionPolicy fromEnvironment() {
        ...
        names.addAll(readList(System.getenv("REALDIFF_REDACT_NAMES")));
        return new RedactionPolicy(names, readList(System.getenv("REALDIFF_REDACT_TYPES")),
            readList(System.getenv("REALDIFF_REDACT_PATHS")));
    }
