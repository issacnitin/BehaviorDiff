...
from behaviordiff_python.monitor import Monitor, Scope, install, uninstall
...
class MonitoringTests(unittest.TestCase):
    ...
    def test_installs_monitor_and_scopes_callbacks_to_repository(self):
        ...
        os.environ["BEHAVIORDIFF_REPOSITORY_ROOT"] = str(root)
        os.environ["BEHAVIORDIFF_INCLUDE_NAMESPACES"] = "tests"
        monitor = install(lambda event, code, value: events.append((event, code.co_name, value)))
