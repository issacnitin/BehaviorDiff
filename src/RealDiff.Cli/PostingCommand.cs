    ...
    internal static class PostingCommand
    {
        internal static int Run(string[] args)
        {
            ...
            try
            {
                ...
                if (String(root, "schema") != "realdiff.findings/1")
                {
                ...
                if (status != "analyzed")
                {
                    WriteWarning(provider, "RealDiff could not analyze this PR; see the posted reason.");
                ...
                {
                    Console.Error.WriteLine("RealDiff gate failed: " + unexpected + " unexpected member(s).");
                    return ExitCodes.UnexpectedFound;
                }

                WriteWarning(provider, "RealDiff found " + unexpected
